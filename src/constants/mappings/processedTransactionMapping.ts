...
export const PROCESSED_TRANSACTION_LABELS = {
  ...
  CDL_TRANS_AR_NAME: 'Asset Register Name',
  CDL_TRANS_BP_ID: 'Asset Register ID',
  CDL_TRANS_AR_CIF: 'Asset Register CIF',
  CDL_TRANS_MF_NAME: 'Management Firm Name',
  CDL_TRANS_BPA_CIF: 'Management Firm CIF',
...
export const PROCESSED_TRANSACTION_LABELS_BY_CATEGORY = {
  ...
  BUILD_PARTNER: {
    CDL_TRANS_AR_NAME: PROCESSED_TRANSACTION_LABELS.CDL_TRANS_AR_NAME,
    CDL_TRANS_BP_ID: PROCESSED_TRANSACTION_LABELS.CDL_TRANS_BP_ID,
    CDL_TRANS_AR_CIF: PROCESSED_TRANSACTION_LABELS.CDL_TRANS_AR_CIF,
