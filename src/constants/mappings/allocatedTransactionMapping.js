...
export const ALLOCATED_TRANSACTION_LABELS = {
  ...
  CDL_TRANS_AR_CIF: 'Project Account (CIF)',
  CDL_TRANS_AR_NAME: 'Developer Name',
  CDL_TRANS_MF_NAME: 'Project Name',
  CDL_TRANS_MF_REGULATOR: 'Project Regulator ID',
...
export const getAllocatedTransactionTableColumns = () => {
  return [
    ...
    {
      configId: 'CDL_TRANS_AR_CIF',
      key: 'projectAccountId',
      label: getAllocatedTransactionLabel('CDL_TRANS_AR_CIF'),
      type: 'text',
      width: 'w-48',
      sortable: true,
    },
    {
      configId: 'CDL_TRANS_AR_NAME',
      key: 'developerName',
      label: getAllocatedTransactionLabel('CDL_TRANS_AR_NAME'),
      type: 'text',
      width: 'w-48',
      sortable: true,
    },
    ...
    {
      configId: 'CDL_TRANS_MF_REGULATOR',
      key: 'projectRegulatorId',
      label: getAllocatedTransactionLabel('CDL_TRANS_MF_REGULATOR'),
      type: 'text',
      width: 'w-40',
      sortable: true,
    },
